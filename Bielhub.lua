...
local Section = CRD:AddSection({Name = " Creator Tz </>„"});
CRD:AddLabel("Dev - Scritp: Tz single");
local function copyText()
    local textToCopy = "https://discord.gg/25ms";
    setclipboard(textToCopy);
    OrionLib:MakeNotification({
        Name = "Texto Copiado",
        Content = "O link do dc foi copiado para a area de transferência",
...
notificationToggle = HH:AddToggle({
    Name = "Notificação: Entrada/Saida",
    Default = true,
