        ...
        function Window:NewTab(mmb)
            ...
            function newmm:NewParagraph(cf)
                local paragraphnew
                newTitle = cf.Title or "Thexze Hub"
                ...
                function paragraphnew:Set(cf2)
                    newTitle = cf2.Title or "Thexze Hub"
        ...
        function SaveSettings2()
            ...
            if not isfolder("Thexze Hub") then
                makefolder("Thexze Hub")
            end
            writefile("Thexze Hub/" .. SaveFileName2, HttpService:JSONEncode(Settings2))
        end
        ...
        function ReadSetting2()
            local s, e =
                ...
                function()
                    ...
                    return HttpService:JSONDecode(readfile("Thexze Hub/" .. SaveFileName2))
                end
            )
            if s then
                return e
